...
/**
 * Formata uma data curta (dd/mm/yyyy) no fuso de São Paulo.
 * Evita pegar o dia do ISO UTC (ex.: 01/07 22h BRT → 02/07Z).
 */
...
/**
 * Converte ISO/Date para valor de input datetime-local no fuso de São Paulo.
 */
